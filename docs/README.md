...
adds necessary [FAPI 2.0 Security Profile - Implementer's Draft 02][] behaviours:
...
[FAPI 2.0 Security Profile - Implementer's Draft 02]: https://openid.net/specs/fapi-2_0-security-profile-ID2.html
